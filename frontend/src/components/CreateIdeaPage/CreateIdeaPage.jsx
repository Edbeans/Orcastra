...
import { createIdea, clearIdeaErrors } from "../../store/idea";
...
export default function CreateIdeaPage() {
    ...
    const ideaErrors = useSelector(state => state.errors.ideas)
    ...
    const handleCipSubmit = async (e, errors) => {
        ...
        try {
          const res = await dispatch(createIdea(title, body, images));
          if (res._id) {
            // If the createIdea action was successful, redirect to the idea page
            history.push(`/idea/${res._id}`);
            setTitle('');
            setBody('');
            setImages([]);
            setImageUrls([]);
            ...
            <div className="cip-card-container" data-aos="fade-up" data-aos-duration="2000" >
                <form className="cip-card" onSubmit={(e) => handleCipSubmit(e, errors)}>
                    <div className="cip-card-title">
                        ...
                        <div className="idea-form-errors"><h1>{ideaErrors?.title}</h1></div>
                    ...
                    <div className="cip-card-description">
                        ...
                        <div className="body-and-error"><div className="idea-form-errors"><h1>{ideaErrors?.body}</h1></div>
                            <div className="body-count">{body.length}/280</div>
                        </div>
