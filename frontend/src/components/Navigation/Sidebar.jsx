  ...
  return (
    <div className='sidenav-container'>
      <div className={open ? 'sidenav' : 'sidenavClosed'}>
        <div>
          <button
            className={open ? 'menu-buttonOpen' : 'menu-button'}
            onClick={toggleOpen}
          >
            <MenuIcon />
          </button>
            ...
            {navData.map((item) => (
              ...
              >
                <div className='item-icon'>
                  {item.icon}
                  <span className='item-icon-tooltip'>
                    {item.text}
                  </span>
                </div>
                <span
                  className={open ? 'linkText' : 'linkTextClosed'}
                >
                  {item.text}
                </span>
              </NavLink>
        ...
        <div
          className={
            open ? 'sideitem-authfunctions-containerOpen' : ''
          }
        >
          {!sessionUser ? (
